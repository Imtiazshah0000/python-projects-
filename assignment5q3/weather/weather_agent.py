...
def main():
   ...
   agent = Agent(
      name="Multi-Tool Bot 🛠️",
      instructions="A helpful Multi-Tool Agent. Use the add tool to add two numbers and the weather tool to get weather information.",
      model=model,
   ...
   while True:
       ...
       if user_question.lower().capitalize() in ["exit", "quit"]:
           print("Goodbye! 👋")
           break
